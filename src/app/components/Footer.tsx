...
export default function CenteredWithLogo() {
  ...
  return (
    <div className="border-t border-neutral-100 dark:border-white/[0.1] px-8 py-20 bg-[#020618] dark:bg-neutral-950 w-full relative overflow-hidden">
      <div className="max-w-7xl mx-auto text-sm text-neutral-500  justify-between items-start  md:px-8">
        <div className="flex flex-col items-center justify-center w-full relative">
          <ul className="transition-colors flex sm:flex-row flex-col hover:text-text-neutral-800 text-neutral-400 dark:text-neutral-300 list-none gap-4">
            {pages.map((page, idx) => (
        ...
        <div className="flex sm:flex-row flex-col justify-between mt-8 items-center w-full">
          <p className="text-neutral-00 dark:text-neutral-400 mb-8 sm:mb-0">
            &copy; Devs & Designers
          </p>
